      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-600 mb-8 max-w-2xl mx-auto">
            Master personal finance, investing, and money management with
            AI-powered lessons and personalized guidance
          </p>
          ...
          <div className="flex gap-4 justify-center">
            ...
            <Link href="/dashboard/chat">
              <Button
                size="lg"
                variant="outline"
                className="text-lg px-8 border-slate-300"
              >
                Chat with AI
              </Button>
            </Link>
          ...
          <CardContent className="p-12">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-slate-300 mb-6 text-lg">
                Join thousands of learners mastering personal finance with
